...
import WidgetCount from "src/pages/DashboardEcommerce/AdminDashboard/Widgets/WidgetCount";
...
const widgetsData = [
  ...
  },
  {
    ...
    separator: ",",
    suffix: "",
    route: "/workOrderList/emergency",
    api: getEmergencyCount,
    component: WidgetCount,
    name: "count",
  },
  {
