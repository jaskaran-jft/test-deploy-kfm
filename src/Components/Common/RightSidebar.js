...
import { changeUserLayout } from "../../helpers/AuthLogin/auth";

const RightSidebar = () => {
  const dispatch = useDispatch();
  const [show, setShow] = useState(false);
  const { layoutOpenMenu } = useSelector((state) => ({
    layoutOpenMenu: state.Layout.layoutOpenMenu || false,
  }));
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            ...
                            setUserLayout({ layout: e.target.value });
                          }
                        }}
                        ...
                        <input
                          ...
                          onChange={(e) => {
                            if (e.target.checked) {
                              ...
                              setUserLayout({ colorScheme: e.target.value });
                            }
                          }}
                        />
                        <label
                      ...
                      <input
                        ...
                        onChange={(e) => {
                          if (e.target.checked) {
                            ...
                            setUserLayout({ topbarColor: e.target.value });
                          }
                        }}
                      />
                      <label
