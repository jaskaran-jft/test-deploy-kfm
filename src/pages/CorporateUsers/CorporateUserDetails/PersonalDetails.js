...
import { updateTenantUserDetails } from "src/helpers/TenantMethod/tenant";
...
export default function PersonalInfo(props) {
  ...
  const handleSubmit = async (values) => {
    setLoading(true);
    try {
      const response = await updateTenantUserDetails(values, details.id);
  ...
  return (
    <React.Fragment>
      {!edit && !loading && tags.includes(CONSTANT.TENANT_USER_UPDATE) && (
