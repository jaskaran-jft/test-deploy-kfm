...
import { getClientUserList } from "src/helpers/ClientMethod/client";
...
const ClientUserList = (props) => {
  ...
  const handleView = (row) => {
    props.history.push(`/clientUserDetails/${row.userid}`);
  };
    ...
    <React.Fragment>
      <div className="page-content">
        <Container fluid={true}>
          <BreadCrumb title={"Brand Users"} pageTitle="Users" />
          ...
          <Card>
            <CardBody>
              <Row className="col-md-12 d-flex justify-content-between align-items-center">
                ...
                <Col className="flex-shrink-0">
                  <TableListHeader
                    ...
                    show={tags.includes(CONSTANT.ADD_CLIENT_USER)}
                    onClick={() => props.history.push("/addClientUser")}
              ...
              <ReactDataTable
                title=""
                columns={columns}
                api={(data) => getClientUserList(data)}
...
export default withRouter(ClientUserList);
