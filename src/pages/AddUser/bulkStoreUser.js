...
import Sample from "../../assets/files/import_store_users_sample.csv";
          ...
          editRow === row.id ? (
            ...
            >
              {((row["Is Manager"] || row["isManager"]) === true
                ? "Yes"
                : "No") || <i style={{ color: "silver" }}>Empty</i>}
            </p>
          ),
        sortable: true,
      },
  ...
  const toggleTab = (tab, value) => {
    if (activeTab === 1) {
      if (!store || !store.storeName) {
        Notify("Please Select a Site", false);
        return;
      } else if (errors > 0) {
        ...
        <Container fluid={true}>
          <Row>
            <Col>
              <Card>
                <CardHeader>
                  <h4 className="card-title mb-0">Add Multiple Site Users</h4>
                </CardHeader>
                        ...
                        <div>
                          <div className="text-center">
                            ...
                            <p className="text-muted">
                              You have Successfully added Site users
                            </p>
                          </div>
                          <Button
                            type="button"
                            onClick={() => props.history.push("/storeUserList")}
                            color="primary"
                          >
                            Go Back
                          </Button>
